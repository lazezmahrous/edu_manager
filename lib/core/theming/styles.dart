...
class TextStyles {
  ...
  static TextStyle font35SemiBold = TextStyle(
    fontSize: 35.sp,
    fontWeight: FontWeightHelper.semiBold,
  );
  ...
  static TextStyle font19BlueBold = TextStyle(
    fontSize: 19.sp,
  ...
  static TextStyle font10GrayMedium = TextStyle(
    fontSize: 10.sp,
  ...
  static TextStyle font17MainOrangeWithUnderLineRegular = TextStyle(
    fontSize: 17.sp,
    fontWeight: FontWeightHelper.regular,
    color: ColorsManager.mainOrange,
    decoration: TextDecoration.underline,
    decorationColor: ColorsManager.mainOrange,
  );
